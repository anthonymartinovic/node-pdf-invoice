  ...
  return {
    ...
    genFooter(){
      ...
      doc
        ...
        .text('Westpac', CONTENT_LEFT_PADDING, startYOffset + 28, { align: 'center' })
        .text('BSB: 032-250', CONTENT_LEFT_PADDING, startYOffset + 42, { align: 'center' })
        .text('Account no: 442-828', CONTENT_LEFT_PADDING, startYOffset + 56, { align: 'center' })
    ...
    genTableRow(){
      ...
      doc
        ...
        .text(numeral(totalAmount).format('$ 0,00.00'), CONTENT_LEFT_PADDING + 430, finalRowOffset + 42);
